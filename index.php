...
<html lang="en">
  ...
  <body style="background-color: black;">
    <div class="container-fluid" style="background-color:#666666;text-align: center;">
       ...
       <h1>Diego Daniel Vazquez</h1>
       <img src="Cliente/Img/ItsaoLogo.png" alt="" width="100" height="100">
</div>
<div class="container" style="background-color:#deddd7;">
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Correo del usuario</label>
  <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Area de texto de ejemplo</label>
...
<div class="input-group mb-3">
  <input type="text" class="form-control" placeholder="Recipiente del usuario" aria-label="Recipient's username" aria-describedby="basic-addon2">
  <span class="input-group-text" id="basic-addon2">@example.com</span>
</div>

<div class="mb-3">
  <label for="basic-url" class="form-label" style="color: White;">Tu url</label>
  <div class="input-group">
    <span class="input-group-text" id="basic-addon3">https://example.com/users/</span>
    <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3 basic-addon4">
  </div>
  <div class="form-text" id="basic-addon4" style="color: White;">Example help text goes outside the input group.</div>
</div>
